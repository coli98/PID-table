...
name_file='P='+ str(P) + 'I='+ str(I) + 'D=' + str(D) + t +'.csv'

with open(name_file, 'w', encoding='utf-8') as csvfile:
    csvwriter = csv.writer(csvfile)
    csvwriter.writerow(['czas[s]', 'pozycja_x[pixel]', 'wyjscie_x', 'bład errox_x', 'P=' + str(P), 'I= ' + str(I), 'D= ' + str(D)])
    ...
    while True:
        ...
        csvwriter.writerow([round(elapsed_time,2), x_medium, round(output), error_x]) #, output])
